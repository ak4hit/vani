"""Prompt Builder - Dynamically compiles business knowledge base, FAQs, and voice persona into LLM system prompts."""
...
def build_system_prompt(profile: BusinessProfile) -> str:
    ...
    Adheres to conversational phone rules, compliance boundaries, and dynamic FAQ injection.
    """
    faq_section = ""
    if profile.faqs:
...
4. Answer questions directly using the business description and FAQs below. If you do not know the answer, do not guess; politely inform the caller and offer assistance.
5. {escalation_line}
